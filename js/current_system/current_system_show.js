var CurrentSystem={
	...
	getCurrentSystemList : function(){
		var ajax={
			url : '/current_system/getCurrentSystemProduct_EOL_0/',
		...
		if(json["list"].length>0){
			for(var i = 0; i<json["list"].length; i++){
				var data = json["list"][i];
					...
					html+="<div class=\"col-md-3\" style=\"width: 100%; \">";
					html+="<div class=\"box box-warning box-solid\">";
					html+="<div class=\"box-header with-border\" style=\"background: "+color+"\">";
					...
					html+="</div></div>";
					if(i==1 || i==3 || i==5 || i==7 || i==json["list"].length-1){
						html+="</div>";
					}
			}
		}
	...
	selectCurrentSystem : function(product_name){
		location.href = "/current_system/getHomePage/?product_name="+product_name;
	},
